...
static const char *colors[][3]      = {
	...
	/*               fg         bg           border     */
	[SchemeNorm] = { col_base3, col_base025, col_base025 },
	[SchemeSel]  = { col_base3, col_blue,    col_blue    },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_base025, "-nf", col_base3, "-sb", col_blue, "-sf", col_base3, NULL };
